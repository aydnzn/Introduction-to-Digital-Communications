...
modulator_obj_16qam = comm.RectangularQAMModulator(M,'SymbolMapping', 'Gray', 'NormalizationMethod','Average Power');
...
sim_res=[errs nframes]
save 16QAM_gray_demo.mat sim_res
...
xlabel('Es/No (in dB)');
ylabel('BER');
legend('16QAM BER versus Es/No GRAY', 'theoretical 16QAM BER versus Es/N0');
