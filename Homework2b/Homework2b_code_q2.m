...
figure(1);
semilogy(snr_db-10*log10(1), errs./nframes/number_of_bits, '-x'); %BER in Eb/No
hold on;
grid on;
qpsk_errs = [85035;58149;32432;13866;3530;455;150;2;0;0;0];
qpsk_nframes = [100;100;100;100;100;104;718;2000;2000;2000;2000];
semilogy(snr_db - 10*log10(2), qpsk_errs./qpsk_nframes/number_of_bits, '-x'); % BER in Eb/No
...
xlabel('Eb/No (in dB)'); 
ylabel('BER');
legend('BPSK BER versus Eb/No', 'QPSK BER versus Eb/No', 'theoretical BPSK BER versus Eb/No' );
