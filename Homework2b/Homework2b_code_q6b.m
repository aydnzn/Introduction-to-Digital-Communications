...
modulator_obj_8psk = comm.PSKModulator(8, 0,'SymbolMapping', 'Gray');
...
sim_res=[errs nframes]
save 8PSK_gray_demo.mat sim_res
...
xlabel('Es/No (in dB)');
ylabel('BER');
legend('8PSK BER versus Es/No GRAY', 'theoretical 8PSK BER versus Es/N0');
